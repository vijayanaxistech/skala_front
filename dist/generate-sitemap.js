...
function getBlogRoutes() {
    ...
    return blogs.map(function (b) { return "/blog/".concat(b.slug); });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    sitemapEntries = allRoutes.map(function (url) { return ({
                        url: url,
                        changefreq: 'weekly',
                        priority: 0.7,
                    }); });
                    sitemap = new sitemap_1.SitemapStream({ hostname: BASE_URL });
                    return [4 /*yield*/, (0, sitemap_1.streamToPromise)(stream_1.Readable.from(sitemapEntries).pipe(sitemap)).then(function (data) {
